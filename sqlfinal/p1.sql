...
VALUES
  (1, 'John', 'Manager', DATE('1980-12-17'), 5000, NULL, 10),
  (2, 'Anna', 'Manager', DATE('1981-02-20' ), 5500, NULL, 20),
  (3, 'Mike', 'Salesman', DATE('1981-05-10'), 3000, 500, 20),
  (4, 'Isabel', 'Salesman', DATE('1982-03-15'), 3200, 200, 20),
  (5, 'Robert', 'Clerk', DATE('1980-09-25'), 2000, NULL, 10),
  (6, 'Linda', 'Analyst', DATE('1981-09-30'), 4000, NULL, 30),
  (7, 'Eric', 'Clerk', DATE('1982-11-05'), 2200, NULL, 10);
